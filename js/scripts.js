...
$(function () {
	...
	$container_clients.imagesLoaded(function(){
		$container_clients.multipleFilterMasonry({
	...
	$container_blog.imagesLoaded(function(){
		$container_blog.multipleFilterMasonry({
			itemSelector: '.box-item',
			percentPosition: true,
			gutter: 0
		});
	...
	/* Initialize masonry items */
	var $container_works = $('.section.works .box-items');
	
	$container_works.imagesLoaded(function(){
		$container_works.multipleFilterMasonry({
			itemSelector: '.box-item',
